...
<head>
	...
	<title>Historial | Gestor de tiempo</title>
...
?>
	<header id="header">
		<hgroup>
			<h1 class="site_title"><?php echo __('History', $lang) ?></h1>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			...
			<a class="current"><?php echo __('History', $lang) ?></a>
			</article>
		</div>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle"><!--Opciones-->
			...
			<li class="icono_gb"><a href="historial.php?lang=en">  Ingles</a></li>
			<li class="icono_es"><a href="historial.php?lang=es">  Castellano</a></li>
	...
	<section id="main" class="column">
		<article class="module width_full">
			<header><h3><?php echo __('History', $lang) ?></h3></header>
			...
			<tr><h1><td><?php echo __('Offer', $lang) ?></td><td><?php echo __('Rating', $lang) ?></td></h1></tr>	
			<?php 
				...
				if(count($historial) != 0){
					...
					<tr> 
						...
						<td> <input type='button' value="<?php echo __('Rate', $lang); ?>" onClick ="window.location.href='valorar.php'"/> </td>
