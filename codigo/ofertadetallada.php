...
?>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle"><!--Opciones-->
			...
			<li class="icono_gb"><a href="ofertadetallada.php?lang=en">  Ingles</a></li>
			<li class="icono_es"><a href="ofertadetallada.php?lang=es">  Castellano</a></li>
		</ul><!--fin opciones-->
			...
			<header><h3><?php echo __('Offer Name', $lang).': '; echo $oferta->getnombreoferta() ?></h3></header>
				...
				<div style="display: block;" id="tab1" class="tab_content">
					...
					<tbody> 
						...
						<tr>
							<td><input type="submit" name="crear" value=<?php echo __('Do it', $lang) ?> onclick=""></td>
							<td><input type="submit" name="crear" value=<?php echo __('Back', $lang) ?> onclick="javascript:history.back()"></td>
						</tr>
