...
<html lang="en">
    ...
    <body>
        ...
        //echo $id;
        $oferta = Controlador::buscarOfertaSegunPatron($cat, $contenido);
                            ...
                            <tbody> 
                                ...
                                if (!$oferta)
                                    ...
                                    foreach ($oferta as $lineaoferta) {
                                        ...
                                        $nombrecategoria = Controlador::ListarCategoriaNo($lineaoferta["idcategoria"]);
                                        ?>
                                        <tr>
                                            <td><?php echo $nombrecategoria ?></td>
                                            <td><?php echo $lineaoferta["nombreoferta"] ?></td>
                                            <td><?php echo $lineaoferta["valoracion"] ?></td>
                                            <td><a href ="ofertadetallada.php?lang=<?php echo $lang; ?>&idoferta=<?php echo $lineaoferta["idoferta"]; ?>&email=<?php echo $lineaoferta["email"]; ?>"><?php echo __('View', $lang) ?></a></td>
                                        </tr>
                                        <?php
                                    }
                                }
