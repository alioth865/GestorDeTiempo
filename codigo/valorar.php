...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="panel_administrador.php">Valorar</a></h1>
	...
	<section id="main" class="column">
		<article class="module width_full">
			...
			<?php 
				for($i =0; $i<5; $i++){ ?>
				 <tr> 
    				<td>Nombre de la oferta <?php echo $i+1;?></td> 
    				<td>Persona <?php echo $i+1?></td> 
    				<td><input type="submit" value="Valorar" onclick="window.location.href='valoracion.php'">
