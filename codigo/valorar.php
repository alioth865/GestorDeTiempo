...
<head>
	...
	<title>Valorar | Gestor de tiempo</title>
...
?>
	<header id="header">
		<hgroup>
			<h1 class="site_title"><?php echo __('Rate', $lang) ?></h1>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle"><!--Opciones-->
			...
			<li class="icono_gb"><a href="valorar.php?lang=en">  Ingles</a></li>
			<li class="icono_es"><a href="valorar.php?lang=es">  Castellano</a></li>
	...
	<section id="main" class="column">
		<article class="module width_full">
			...
			<?php 
				for($i =0; $i<5; $i++){ ?>
				 <tr> 
    				<td><?php echo __('Name of the offer', $lang) ?> <?php echo $i+1;?></td> 
    				<td><?php echo __('Person', $lang) ?> <?php echo $i+1?></td> 
    				<td><input type="submit" value=<?php echo __('Rate', $lang) ?> onclick="window.location.href='valoracion.php?lang=<?php echo $lang; ?>'">
