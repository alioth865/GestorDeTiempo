...
<body>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle"><!--Opciones-->
			...
			<li class="icn_eliminar_oferta"><a href ="#">Eliminar</a></li>			
		...
		<article class="module width_full">
			...
			<!-- codigo php para crear una tabla-->
				...
				<tr>
					...
					<td><input type="submit" name="buscar" value="Buscar"></td></form>
					
				</tr>
				<tr>
					<td><?php echo "nombre de oferta encontrada" ?></td>
					<td><input type="button" name="eliminar" value="Eliminar" onClick="window.location.href='#'"></td>
				</tr>
			</tbody> 
			</table>
