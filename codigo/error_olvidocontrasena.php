...
?>
	...
	<header id="header">
		<hgroup>
			...
			<li class="icono_gb"><a href="error_olvidocontrasena.php?lang=en">  Ingles</a></li>

			<li class="icono_es"><a href="error_olvidocontrasena.php?lang=es">  Castellano</a></li>	
		</hgroup>
		...
		<article class="module width_full">
			<header><h3 style ="margin: .5em .5em .1em .5em"><?php echo __('Login', $lang) ?></h3></header>
				<div class="module_content">
						<fieldset>
							<label><?php echo __('Please contact an administrator', $lang) ?></label>
							<br>
							<br>
							<br>
							<br>
