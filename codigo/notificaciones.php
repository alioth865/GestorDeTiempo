		...
		<article class="module width_full">
			...
			<?php 
				...
				<tr> 
	    				...
	    				<td><?php echo if($status == 0){echo "Rechazada"}else{echo "Aceptada"} ?></td> 
	    				<td><?php echo $notificacion['nombre'] ?></td> 
	    				<td><?php echo $notificacion['emailofertante'] ?></td>
					<td><input type="button" name="<?php $i++ ?>" value="borrar" onClick = "<?php Controlador::eliminarNotificacion($notificacion['idnotificacion']) ?> window.location.href='notificaciones.php?lang=<?php echo $lang; ?>'"/></td>
				</tr><?php ;
				}
			?> 
