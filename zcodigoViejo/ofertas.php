...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="panel_administrador.php">Mis Ofertas</a></h1>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle"><!--Opciones-->
			...
			<li class="icn_new_article"><a href ="crear_oferta.php">Crear oferta</a></li>
	...
	<section id="main" class="column">
		<article class="module width_full">
			<header><h3>Mis Ofertas</h3></header>
